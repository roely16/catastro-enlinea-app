<template>
    <div>
        <footer>
            <div class="container">
                <div class="row top-generic">
                    <div class="col-md-4">
                        <div class="line"></div>
                    </div>

                    <div class="col-md-4 title-section">
                        <p>BÚSCANOS MUNIGUATE</p>
                    </div>
            ...
            <div class="container">
                <div class="row" style="padding-right: 15px; padding-left: 15px;">
                    <div class="col-md-12 line line-footer"></div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12" data-last="sub-footer">
                        <div>21 Calle 6-77 Zona 1, Centro Cívico, Palacio Municipal. Ciudad de Guatemala, Guatemala, Centroamérica.</div>
                        <div class="iid">Powered by I<sup>2</sup>+D Informática</div>
                    </div>
                </div>
            </div>
        </footer>
